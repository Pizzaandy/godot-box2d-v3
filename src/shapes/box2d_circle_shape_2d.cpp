...
ShapeID Box2DCircleShape2D::build(b2BodyId p_body, Transform2D p_transform, b2ShapeDef &p_shape_def) {
	b2Circle circle;
...
bool Box2DCircleShape2D::make_circle(Transform2D p_transform, Variant p_data, b2Circle &p_circle) {
