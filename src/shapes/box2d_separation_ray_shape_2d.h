...
public:
	...
	int cast(const CastQuery &p_query, LocalVector<CastHit> &p_results) const { return 0; }
	int overlap(const OverlapQuery &p_query, LocalVector<ShapeOverlap> &p_results) const { return 0; }
	...
	static bool make_capsule_segment(const Transform2D &p_transform, const Variant &p_data, b2Capsule &p_capsule);
};